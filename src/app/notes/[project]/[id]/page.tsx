// src/app/notes/[project]/[id]/page.tsx
...
export default async function NotesDetailPage({
  ...
  const { project: p, id } = await params;

  if (!isProject(p)) {
    return (
      <PageShell title="Note" subtitle="Project not found">
  ...
  if (error || !data) {
    return (
      <PageShell title="Note" subtitle="Not found">
