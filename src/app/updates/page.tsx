...
async function fetchTop(project: "focuspilot" | "shiftrix" | "linguai", n = 3): Promise<DevlogRow[]> {
    ...
    <PageShell title="Updates" subtitle="Neuigkeiten & Devlogs von Softbrew Studio.">
      <div className="grid gap-6 md:grid-cols-3">
        <section className="rounded-brand p-5 bg-product-focuspilot text-white">
          ...
          <div className="mt-4">
            <a
              className="inline-flex items-center gap-1 rounded-lg border border-white/70 px-3 py-2 text-white visited:text-white hover:bg-white/10 active:bg-white/15 focus-visible:outline focus-visible:outline-2 focus-visible:outline-white/60"
